    ...
    return (
        <div>
            <div className="  bg-cover mx-auto rounded-3xl px-18 lg:px-28 py-20  lg:py-32 text-center bg-[url('https://i.postimg.cc/0QySrt5c/banner.png')] bg-no-repeat bg-center" >
                ...
                <p className="text-[#FFFFFF] font-normal text-sm lg:text-lg mb-6 lg:mb-10  mt-4 lg:mt-6">Embark on a culinary journey tailored to your preferences and skill level. Elevate your cooking prowess with our expert guidance and personalized instruction.</p>
